    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="logout.php" aria-expanded="false"><button class="btn btn-danger">LOGOUT</button></a></li>
                    </ul>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/5.jpg" class="rounded-circle" width="150" />
                                    <h4 class="card-title m-t-10">Muhammad Muslim Abdul Jabbaar</h4>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6>mmuslimabdulj@gmail.com</h6> <small class="text-muted p-t-30 db">Phone</small>
                                <h6>+6281313357536</h6> <small class="text-muted p-t-30 db">Address</small>
                                <h6>Kp. Ciheulang, Langensari, Karangtengah, Cianjur, Jawa Barat</h6>
                                <div class="map-box">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Muhammad Muslim Abdul Jabbaar" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="mmuslimabdulj@gmail.com" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="+6281313357536" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <footer class="footer text-center">
                M Muslim Abdul J <a href="https://www.facebook.com/mmuslimabdulj"></a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->

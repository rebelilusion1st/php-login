...
<head>
    ...
    <title>Buat akun terlebih dahulu</title>
...
<body>
    <div class="signup-form">
        <form action="" method="post">
            <h2>Register</h2>
            <p class="hint-text">Buat akun terlebih dahulu</p>
            ...
            <div class="form-group">
                <?php if (isset($_POST['register'])) : ?>
                    <div class="alert alert-success" role="alert">
                        <h4 class="alert-heading">Menambahkan <b><?= $_POST["username"]; ?></b> berhasil!</h4>
                        ...
                        <hr>
                        <p class="mb-0"><b>Silahkan masuk ke halaman <a href="login.php"><span class="login">LOGIN</span></a></b></p>
                    </div>
                <?php endif; ?>
            </div>
            <div class="form-group">
        ...
        <div class="text-center">Sudah punya akun? <a href="login.php" style="color:black">Sign in</a></div>
    </div>
    <!-- <script>
